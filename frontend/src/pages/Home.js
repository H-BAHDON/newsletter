...
import { ArrowRight, Users, TrendingUp, Globe, BookOpen, Network, Leaf, FileText, Cpu, Lightbulb } from 'lucide-react';
...
const sectionImages = {
  ...
  'point-of-view': 'https://images.unsplash.com/photo-1455390582262-044cdead277a?w=800&q=80'
};

const sectionIcons = {
  'rachel-head': Lightbulb,
  ...
  'sustainability': Leaf,
  'point-of-view': FileText
};

const sectionDescriptions = {
  'rachel-head': 'Leadership insights and strategic updates',
  'great-place-to-work': 'Celebrating our culture and workplace excellence',
  'ai': 'Latest AI initiatives, toolkits and resources',
  ...
  'point-of-view': 'Share your ideas, blogs and expertise'
};
